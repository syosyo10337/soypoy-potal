...
import type { CustomCalendarProps } from "./type";
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        today: cn(
          "border border-primary rounded-md data-[selected=true]:rounded-none",
      ...
      defaultMonth={dateDefaultMonth as any}
      month={dateMonth as any}
